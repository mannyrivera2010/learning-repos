 ...
 *******************************************************************************/
package com.earasoft.rdf4j.sail.rocksDbStore.model;

import org.eclipse.rdf4j.model.impl.SimpleBNode;
import com.earasoft.rdf4j.sail.nativeStore.datastore.ValueStoreRevision;
...
public class NativeBNode extends SimpleBNode implements NativeResource {
	...
	public boolean equals(Object o) {
		...
		if (o instanceof NativeBNode && internalID != UNKNOWN_ID) {
			NativeBNode otherNativeBNode = (NativeBNode) o;

			if (otherNativeBNode.internalID != UNKNOWN_ID && revision.equals(otherNativeBNode.revision)) {
