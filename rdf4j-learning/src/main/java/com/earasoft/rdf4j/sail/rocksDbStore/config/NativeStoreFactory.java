 ...
 *******************************************************************************/
package com.earasoft.rdf4j.sail.rocksDbStore.config;
...
/**
 * A {@link SailFactory} that creates {@link RocksDbStore}s based on RDF configuration data.
 * 
...
public class NativeStoreFactory implements SailFactory {
	...
	public Sail getSail(SailImplConfig config) throws SailConfigException {
		...
		RocksDbStore nativeStore = new RocksDbStore();
