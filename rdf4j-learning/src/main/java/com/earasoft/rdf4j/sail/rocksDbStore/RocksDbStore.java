...
import com.earasoft.rdf4j.sail.rocksDbStore.model.MemoryOverflowModel;
 ...
 * @author jeen
 */
public class RocksDbStore extends AbstractNotifyingSail implements FederatedServiceResolverClient {
	...
	public RocksDbStore(File dataDir) {
		this();
		setDataDir(dataDir);
	}

	public RocksDbStore(File dataDir, String tripleIndexes) {
		this(dataDir);
	...
	protected void initializeInternal() throws SailException {
		...
		try {
			...
			final RocksDbSailStore master = new RocksDbSailStore(dataDir, tripleIndexes, forceSync, valueCacheSize,
				...
				public Model createEmptyModel() {
					return new MemoryOverflowModel() {
						...
						protected SailStore createSailStore(File dataDir) throws IOException, SailException {
							...
							return new RocksDbSailStore(dataDir, getTripleIndexes());
						}
					};
				}
			}) {
	...
	protected NotifyingSailConnection getConnectionInternal() throws SailException {
		try {
			return new RocksDbStoreConnection(this);
		} catch (IOException e) {
			throw new SailException(e);
		}
	}
