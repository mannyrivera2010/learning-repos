 ...
 *******************************************************************************/
package com.earasoft.rdf4j.sail.rocksDbStore.limited;

import java.io.IOException;

import com.earasoft.rdf4j.sail.rocksDbStore.RocksDbStore;
import com.earasoft.rdf4j.sail.rocksDbStore.RocksDbStoreConnection;
 ...
 */
public class LimitedSizeNativeStoreConnection extends RocksDbStoreConnection {
	 ...
	 * @throws IOException
	 */
	protected LimitedSizeNativeStoreConnection(RocksDbStore nativeStore) throws IOException {
		super(nativeStore);
	}
